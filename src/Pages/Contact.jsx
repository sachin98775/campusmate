    ...
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900 transition-colors duration-200">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 mb-6">
          ...
          <p className="text-gray-600 dark:text-gray-300 mt-2">We'd love to hear from you. Send us a message and we'll respond as soon as possible.</p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  required
                  rows="4"
                  className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-none dark:bg-gray-700 dark:text-white"
              ...
              <button
                type="submit"
                className="w-full bg-blue-600 dark:bg-blue-500 text-white py-2 px-4 rounded-lg font-medium hover:bg-blue-700 dark:hover:bg-blue-600 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
              >
                Send Message
              </button>
            </form>
          ...
          <div className="space-y-6">
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <div className="text-gray-600 dark:text-gray-300">support@campusmate.com</div>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <div className="text-gray-600 dark:text-gray-300">123 Campus Drive<br />University City, UC 12345</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            {/* Office Hours */}
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6">
              <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">Office Hours</h2>
