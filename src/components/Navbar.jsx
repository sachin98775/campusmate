        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center">
            <div className="flex-shrink-0">
              <NavLink to="/dashboard" className="text-2xl font-bold text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 transition-colors">
                CampusMate
              </NavLink>
            </div>
          </div>
          ...
          <div className="flex items-center space-x-3">
            ...
            <div className="relative">
              <button 
                ...
                className="flex items-center text-sm rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 hover:ring-2 hover:ring-offset-2 hover:ring-blue-300 transition-all cursor-pointer"
              >
                <div className="h-9 w-9 rounded-full bg-gradient-to-br from-blue-500 to-blue-600 flex items-center justify-center shadow-md hover:shadow-lg transition-shadow">
                  <span className="text-white font-semibold text-sm">{studentData?.name?.charAt(0) || 'S'}</span>
                </div>
              </button>
                ...
                <div className="absolute right-0 mt-2 w-64 bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 py-4 z-50">
                  ...
                  <div className="px-4 pb-3 border-b border-gray-200 dark:border-gray-700">
                    <div className="text-lg font-semibold text-gray-900 dark:text-white">
                      {studentData?.name || 'Sachin'}
                    </div>
                    <div className="text-sm text-gray-600 dark:text-gray-400 mt-1">
                      Roll Number: {studentData?.rollNumber || 'BCA2023001'}
                    </div>
                    <div className="text-sm text-gray-600 dark:text-gray-400">
                      Class: {studentData?.class || 'BCA 3'}
                    </div>
                  </div>
